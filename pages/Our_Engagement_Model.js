...
const Our_Engagement_Model = () => {
  ...
  return (
    <Layout>
      ...
      {/* 
      <section className="service-details-area m-5 px-3  rpt-100 pb-115 rpb-85">
        <Container>
          <div className="row gap-100">
            <div className="col-lg-12">
              <div className="service-details-content">
                <div className="row gap-90 mb-25   justify-content-center  align-items-center">
                  <div className="col-lg-8 order-lg-1 order-sm-2  order-2">
                    <div className="why-choose-content fadeInUp">
                      <h3
                        style={{ fontFamily: "oswald" }}
                      ...
                      <ul className="list-style-three pt-5">
                        ...
                        <li>
                          Seamlessly integrate our dedicated team with your
                          in-house resources, fostering collaboration and
                          knowledge sharing
                        </li>
                        <li>
                          Scale your team up or down according to project
                          demands, with the flexibility to add or remove
                          resources as needed.
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="col-lg-4 order-lg-2 order-sm-1 order-1 ">
                    <div className="why-choose-image fadeInUp rmt-55  d-flex justify-content-center align-items-center">
                      <img
                        src="assets/images/model/Team.png"
                        alt="Why Choose"
                        className="why-choose-img"
                ...
                <div className="row gap-90 mb-25  justify-content-center  align-items-center">
                  <div className="col-lg-4">
                    <div className="why-choose-image rmb-55 d-flex justify-content-center align-items-center ">
                      <img
                        src="assets/images/model/time.png"
                        alt="Why Choose"
                        className="why-choose-img"
                  ...
                  <div className="col-lg-8">
                    <div className="why-choose-content">
                      ...
                      <ul className="list-style-three pt-5">
                        <li>
                          Adapt to changing project requirements with the
                          flexibility to adjust scope, resources, and timelines
                          as needed.
                        </li>
                        <li>
                          Pay only for the actual time and resources utilized,
                ...
                <div className="row gap-90 justify-content-center  align-items-center">
                  <div className="col-lg-8 order-lg-1 order-sm-2  order-2">
                    <div className="why-choose-content">
                      ...
                      <ul className="list-style-three pt-5">
                        ...
                        <li>
                          Transfer project risks to us, as we commit to
                          delivering the agreed-upon scope within the specified
                          budget and timeline
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="col-lg-4 order-lg-2 order-sm-1 order-1 ">
                    <div className="why-choose-image rmt-55 d-flex justify-content-center align-items-center ">
                      <img
                        src="assets/images/model/pay.png"
                        alt="Why Choose"
                        className="why-choose-img "
